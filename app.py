...
SQL_QUERIES = {
	...
	# MODIFICADO: Se añade fecha_prestamo para permitir el filtrado por rango de fechas
	'flujo_material': "SELECT recurso, idInventario, idPrestamo, idDevolucion, fecha_prestamo FROM vw_flujo_material",
